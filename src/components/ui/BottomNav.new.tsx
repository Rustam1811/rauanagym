...
export function BottomNav() {
  ...
  const navItems = [
    { icon: Home, label: 'Home', path: '/hero/home' },
    { icon: Dumbbell, label: 'Workouts', path: '/hero/workouts' },
    { icon: Target, label: 'Programs', path: '/hero/programs' },
    { icon: Trophy, label: 'Arena', path: '/hero/arena' },
    { icon: User, label: 'Profile', path: '/hero/profile' },
  ];
